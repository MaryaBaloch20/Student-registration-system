          ...
          <br> <br>
                  <div class="card">
                    <div class="card-header bg-dark">
                     <h1 class = "text-white text-center"> Insert Student Record </h1>
                     </div>
<br>
                  ...
                  <input type="password" name="password" id="" class ="form-control" placeholder = "Password" required> <br>
                   ...
                   <button type = "submit" name = "registration" class = "btn btn-success text-white sButton"> INSERT
                  </button>

                  <button name = "registration" class = "btn btn-danger text-white cButton"> <a href="display.php" class = "text-white">CANCEL</a>
                  </button>
